...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        /*googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(5.556200, 95.344689))
                .title("hahahahaha"));*/
    ...
    private void loadJSON(){
        ...
        //Toast.makeText(MapsActivity.this, "masuk json", Toast.LENGTH_LONG).show();

        try {
            Client client = new Client();
            Service apiService = client.getClient().create(Service.class);

            Call<List<Partner>> call = apiService.getPartners();

            call.enqueue(new Callback<List<Partner>>() {
                @Override
                public void onResponse(Call<List<Partner>> call, Response<List<Partner>> response) {
                    //Toast.makeText(MapsActivity.this, "retrofit sukses", Toast.LENGTH_LONG).show();
                    if(response != null && response.body().size()>0){
                        //Toast.makeText(MapsActivity.this, "lebih dari nol", Toast.LENGTH_LONG).show();
                        for (int i=0 ; i<response.body().size() ; i++){
                            Partner partner = response.body().get(i);
                ...
                public void onFailure(Call<List<Partner>> call, Throwable t) {
                    Toast.makeText(MapsActivity.this, "Error Fetching Data!", Toast.LENGTH_SHORT).show();
                }
            });
        }catch (Exception e){
